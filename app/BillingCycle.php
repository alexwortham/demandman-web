 ...
 * @property App\ElectricityRate $rate The ElectricityRate used for this billing
 * cycle.
 * @property App\DemandHistory $histories The DemandHistory's associated with this
 * billing cycle.
...
class BillingCycle extends Model
{
	...
	public function histories() {
		return $this->hasMany('App\DemandHistory');
	}

	public function electricityRate() {
		return $this->belongsTo('App\ElectricityRate');
	}
}
